...
<script type="text/javascript">
    ...
    function edit(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('warga/warga/ajax_edit/') ?>" + id,
            type: "GET",
            dataType: "JSON",
    ...
    $('#form').submit(function(e) {
        ...
        if(id_kk == "")
        {
            ...
            if (save_method == 'add') {
                url = "<?php echo site_url('warga/warga/ajax_add') ?>";
            } else {
                url = "<?php echo site_url('warga/warga/ajax_update') ?>";
            }
    ...
    function delete_data(id) {
        ...
        if (confirm('Are you sure delete this data?')) {
            ...
            $.ajax({
                url: "<?php echo site_url('warga/warga/ajax_delete') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function(data) {
    ...
    $(document).ready(function() {
        table = $('#table_warga').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('warga/warga/getPenduduk') ?>",
                "type": "POST"
            },
