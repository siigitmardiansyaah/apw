...
class Timeline_m extends CI_Model
{
	public function __construct()
	{
	  ...
	  public function view($no_rt)
	  {    
		$query = "SELECT * FROM pengumuman inner join penduduk on pengumuman.pembuat = penduduk.id inner join role on penduduk.id = role.id_penduduk where publish = 'Yes' AND penduduk.no_rt = $no_rt order by pengumuman.tanggal desc"; // Query untuk menampilkan semua data siswa        
