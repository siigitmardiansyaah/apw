...
<script type="text/javascript">
    ...
    function lihat(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('rt/kk/ajax_edit/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    $('#form').submit(function(e) {
        ...
        if (nama == "") {
            ...
            if (save_method == 'add') {
                url = "<?php echo site_url('rt/kk/ajax_add') ?>";
            } else {
                url = "<?php echo site_url('rt/kk/ajax_update') ?>";
            }
    ...
    function delete_data(id) {
        ...
        if (confirm('Are you sure delete this data?')) {
            ...
            $.ajax({
                url: "<?php echo site_url('rt/kk/ajax_delete') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function(data) {
    ...
    $(document).ready(function() {
        table = $('#table_kk').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('rt/kk/getKK') ?>",
                "type": "POST"
            },
