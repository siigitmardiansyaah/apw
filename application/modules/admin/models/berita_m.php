...
class Berita_m extends CI_Model
{
	...
	var $column_order = array(null,'pengumuman.judul','pengumuman.isi',null,null,null,null); //set column field database for datatable orderable
	var $column_search = array('pengumuman.judul'); //set column field database for datatable searchable just firstname , lastname , address are searchable
	var $order = array('pengumuman.judul' => 'asc'); // default order 
	...
	public function simpandata($judul,$isi,$foto,$tanggal,$publish) {
		$field = array(
		'judul' => $judul,
		'isi' => $isi,
		'gambar' => $foto,
