  ...
  function getBerita()
    {
        ...
        foreach ($list as $field) {
            ...
            $row[] = $field->nama;
            $row[] = $field->publish;
            $row[] = '<a class="btn btn-xs btn-primary" href="'.base_url('admin/berita/ajax_edit/'.+$field->id_berita).'" title="Edit"><i class="fa fa-edit"></i> Edit</a>
        ...
        $this->form_validation->set_rules(
            ...
            if ($this->form_validation->run() == FALSE) {
               ...
               '</strong></div>'
                ...
                $querysimpandata = $this->berita_m->simpandata($judul,$isi,$tanggal,$publish);
                if ($querysimpandata) {
        ...
        $this->form_validation->set_rules(
            ...
            if ($this->form_validation->run() == FALSE) {
               ...
               '</strong></div>'
                ...
                $this->session->set_flashdata($session);
                redirect('admin/berita/ajax_edit');
                }else
                {
