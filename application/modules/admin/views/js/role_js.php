...
<script type="text/javascript">
    ...
    function edit(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/role/ajax_edit/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    $('#form').submit(function(e) {
        ...
        if (id_penduduk == "") {
            ...
            if (save_method == 'add') {
                url = "<?php echo site_url('admin/role/ajax_add') ?>";
            } else {
                url = "<?php echo site_url('admin/role/ajax_update') ?>";
            }
    ...
    $(document).ready(function() {
        table = $('#table_role').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/role/getRole') ?>",
                "type": "POST"
            },
