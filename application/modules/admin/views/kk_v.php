                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="no_kk" id="no_kk" required placeholder="No Kartu Keluarga" class="form-control" type="numeric">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="kepala_keluarga" required id="kepala_keluarga" placeholder="Nama Kepala Keluarga" class="form-control" type="text">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Status Tinggal KK <span style="color:red"> *</span></label>
                                    <select name="status_kk" required id="status_kk" class="form-control">
