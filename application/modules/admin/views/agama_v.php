          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="table_agama" width="100%" cellspacing="0">
                  <thead>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="agama" id="agama" placeholder="Nama Agama" class="form-control" type="text" required >
