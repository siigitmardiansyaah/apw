                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Pilih Warga <span style="color:red"> *</span></label>
                                    <select name="id_penduduk" id="id_penduduk" required class="form-control">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                <label>No RT <span style="color:red"> *</span></label>
                                <input name="no_rt" id="no_rt" placeholder="Kosongkan jika memilih role RW" class="form-control" type="numeric" required>
                                    <span class="help-block"></span>
                                </div>
                            </div>
