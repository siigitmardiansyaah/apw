                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Kode Alternatif <span style="color:red"> *</span></label>
                                    <input name="kd_alternatif" id="kd_alternatif" placeholder="Kode Alternatif" class="form-control" type="text" required>
