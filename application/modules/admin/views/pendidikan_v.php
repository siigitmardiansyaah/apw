          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="table_pendidikan" width="100%" cellspacing="0">
                  <thead>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="pendidikan" id="pendidikan" placeholder="Nama Pendidikan" class="form-control" type="text" required>
