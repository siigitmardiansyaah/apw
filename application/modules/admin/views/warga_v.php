                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="nik" required id="nik" placeholder="NIK" class="form-control" type="numeric">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="tmpt_lahir" required id="tmpt_lahir" placeholder="Tempat" class="form-control" type="text">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="no_rt" id="no_rt" class="form-control" placeholder="RT" required>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="id_agama" id="id_agama" required class="form-control">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Pekerjaaan <span style="color:red"> *</span></label>
                                    <input name="pekerjaan" required id="pekerjaan" placeholder="Pekerjaan" class="form-control" type="text">                             
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="id_pendidikan" required id="id_pendidikan" class="form-control">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="status_perkawinan" required id="status_perkawinan" class="form-control">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="kewarganegaraan" required id="kewarganegaraan" class="form-control">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Status Kehidupan <span style="color:red"> *</span></label>
                                    <select name="status_hidup" required id="status_hidup" class="form-control">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Status Dalam Keluarga <span style="color:red"> *</span></label>
                                    <select name="status_keluarga" id="status_keluarga" required class="form-control">
                                    <option value="">Pilih Status</option>
